{
  ...
  "@vimium-new-tab" = {
    installation_mode = "force_installed";
    install_url = "https://addons.mozilla.org/firefox/downloads/latest/vimium-new-tab-page/latest.xpi";
    private_browsing = true;
    default_area = "menupanel";
  };
  ...
  "{84c8edb0-65ca-43a5-bc53-0e80f41486e1}" = {
    installation_mode = "force_installed";
    install_url = "https://addons.mozilla.org/firefox/downloads/latest/tweaks-for-youtube/latest.xpi";
    private_browsing = true;
    default_area = "menupanel";
  };
